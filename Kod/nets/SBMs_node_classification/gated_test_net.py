...
"""
from layers.gated_test_layer import GatedTestLayer
from layers.mlp_readout_layer import MLPReadout

class GatedTestNet(nn.Module):
    ...
    def __init__(self, net_params):
        ...
        self.layers = nn.ModuleList([GatedTestLayer(neighbor_aggr_type, hidden_dim, hidden_dim, dropout,
